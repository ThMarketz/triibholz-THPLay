...
const DATA = (() => {
    ...
    (() => {
      ...
      list.push(scn('6v5','defense','Man-down box — deny the post',
        ...
        { '1':'Top of the box — slide to the ball, hands in the lane.',
          ...
          '6':'(excluded — wait in the re-entry corner; back after 18 s, a goal, or an awarded turnover).',
  ...
  const TRIVIA = [
    ...
    { q:'How long is a standard exclusion (player sent out) under the 2025 rules?',
      a:['18 seconds','20 seconds','30 seconds'], correct:0,
      why:'Since 2025 an exclusion lasts 18 seconds — it ends earlier on a goal or when the excluded team is awarded a free throw, goal throw or penalty.' },
    ...
    { q:'How many quarters is a match played in?',
      ...
      why:'Water polo is played in four quarters of 8 minutes actual play; teams switch ends at half-time.' },
    { q:'How long is the field of play, goal line to goal line?',
      a:['25 metres','30 metres','20 metres'], correct:0,
      why:'The 2025 World Aquatics rules set 25 m for both men’s and women’s matches.' },
    { q:'How many timeouts does each team have per match?',
      a:['Two, one minute each','One per quarter','Unlimited'], correct:0,
