...
const ANALYSIS = (() => {
  ...
  function normalizeResult(raw) {
    ...
    if (r.meta && typeof r.meta === 'object') { out.meta = { seconds: +r.meta.seconds || 0, fps: +r.meta.fps || 0, chunks: +r.meta.chunks || 0 }; if (typeof r.meta.videoRef === 'string') out.meta.videoRef = r.meta.videoRef; if (r.meta.field && typeof r.meta.field === 'object') out.meta.field = r.meta.field; }   // whole-video job stats
    return out;
  }
