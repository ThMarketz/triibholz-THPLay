...
const I18N = (() => {
  ...
  const DICT = {
    en: {
      ...
      'nav.dashboard':'Dashboard','nav.playbook':'Playbook','nav.basics':'Basics','nav.film':'Film Room','nav.solutions':'Solutions','nav.season':'Season','nav.trivia':'Trivia','nav.admin':'Admin',
    ...
    de: {
      ...
      'nav.dashboard':'Übersicht','nav.playbook':'Playbook','nav.basics':'Grundlagen','nav.film':'Filmraum','nav.solutions':'Lösungen','nav.season':'Saison','nav.trivia':'Quiz','nav.admin':'Admin',
    ...
    fr: {
      ...
      'nav.dashboard':'Tableau de bord','nav.playbook':'Playbook','nav.basics':'Bases','nav.film':'Salle vidéo','nav.solutions':'Solutions','nav.season':'Saison','nav.trivia':'Quiz','nav.admin':'Admin',
    ...
    it: {
      ...
      'nav.dashboard':'Dashboard','nav.playbook':'Playbook','nav.basics':'Basi','nav.film':'Sala video','nav.solutions':'Soluzioni','nav.season':'Stagione','nav.trivia':'Quiz','nav.admin':'Admin',
