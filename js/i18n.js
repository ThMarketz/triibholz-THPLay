...
const I18N = (() => {
  ...
  const DICT = {
    en: {
      ...
      'view.team':'Team','view.me':'My position','view.steps':'Steps','share.download':'Download','share.share':'Share','share.select':'Select','share.import':'Import','view.focus':'Focus…',
    ...
    de: {
      ...
      'view.team':'Team','view.me':'Meine Position','view.steps':'Schritte','share.download':'Herunterladen','share.share':'Teilen','share.select':'Auswählen','share.import':'Importieren','view.focus':'Fokus…',
    ...
    fr: {
      ...
      'view.team':'Équipe','view.me':'Mon poste','view.steps':'Étapes','share.download':'Télécharger','share.share':'Partager','share.select':'Sélectionner','share.import':'Importer','view.focus':'Focus…',
    ...
    it: {
      ...
      'view.team':'Squadra','view.me':'Il mio ruolo','view.steps':'Passaggi','share.download':'Scarica','share.share':'Condividi','share.select':'Seleziona','share.import':'Importa','view.focus':'Focus…',
