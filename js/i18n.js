...
const I18N = (() => {
  ...
  const DICT = {
    ...
    de: {
      ...
      'view.team':'Team','view.me':'Meine Position','view.steps':'Schritte','view.zones':'Zonen','view.gk':'Torwart-Sicht','view.3d':'3D','share.download':'Herunterladen','share.share':'Teilen','share.select':'Auswählen','share.import':'Importieren','view.focus':'Fokus…',
