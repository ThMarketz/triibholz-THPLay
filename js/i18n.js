...
const I18N = (() => {
  ...
  const DICT = {
    en: {
      ...
      'view.team':'Team','view.me':'My position','view.steps':'Steps','view.zones':'Zones','view.gk':'Keeper view','share.download':'Download','share.share':'Share','share.select':'Select','share.import':'Import','view.focus':'Focus…',
    ...
    de: {
      ...
      'view.team':'Team','view.me':'Meine Position','view.steps':'Schritte','view.zones':'Zonen','view.gk':'Torwart-Sicht','share.download':'Herunterladen','share.share':'Teilen','share.select':'Auswählen','share.import':'Importieren','view.focus':'Fokus…',
    ...
    fr: {
      ...
      'view.team':'Équipe','view.me':'Mon poste','view.steps':'Étapes','view.zones':'Zones','view.gk':'Vue gardien','share.download':'Télécharger','share.share':'Partager','share.select':'Sélectionner','share.import':'Importer','view.focus':'Focus…',
    ...
    it: {
      ...
      'view.team':'Squadra','view.me':'Il mio ruolo','view.steps':'Passaggi','view.zones':'Zone','view.gk':'Vista portiere','share.download':'Scarica','share.share':'Condividi','share.select':'Seleziona','share.import':'Importa','view.focus':'Focus…',
